  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        pill:
          "flex h-auto flex-wrap justify-start gap-2 rounded-none border-0 bg-transparent p-0 shadow-none group-data-horizontal/tabs:min-h-0 group-data-horizontal/tabs:h-auto",
      },
    },
    defaultVariants: {
      variant: "default",
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] items-center justify-center gap-1.5 rounded-md border border-transparent px-1.5 py-0.5 text-sm font-medium whitespace-nowrap text-foreground/60 transition-all group-data-[variant=default]/tabs-list:flex-1 group-data-[variant=line]/tabs-list:flex-1 group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start group-data-[variant=pill]/tabs-list:w-fit group-data-[variant=pill]/tabs-list:flex-none group-data-[variant=pill]/tabs-list:flex-wrap group-data-[variant=pill]/tabs-list:whitespace-normal hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50 has-data-[icon=inline-end]:pr-1 has-data-[icon=inline-start]:pl-1 dark:text-muted-foreground dark:hover:text-foreground group-data-[variant=default]/tabs-list:data-active:shadow-sm group-data-[variant=line]/tabs-list:data-active:shadow-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
        "group-data-[variant=pill]/tabs-list:h-auto group-data-[variant=pill]/tabs-list:min-h-8 group-data-[variant=pill]/tabs-list:rounded-full group-data-[variant=pill]/tabs-list:border group-data-[variant=pill]/tabs-list:px-3 group-data-[variant=pill]/tabs-list:py-1 group-data-[variant=pill]/tabs-list:shadow-none group-data-[variant=pill]/tabs-list:transition-[color,background-color,border-color,transform] group-data-[variant=pill]/tabs-list:duration-150 group-data-[variant=pill]/tabs-list:ease-out group-data-[variant=pill]/tabs-list:after:hidden",
