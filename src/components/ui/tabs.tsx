  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=pill]/tabs-list:data-[state=inactive]:border-[var(--border-default)] group-data-[variant=pill]/tabs-list:data-[state=inactive]:bg-transparent group-data-[variant=pill]/tabs-list:data-[state=inactive]:text-[var(--text-tertiary)] group-data-[variant=pill]/tabs-list:data-[state=inactive]:hover:border-[var(--border-default)] group-data-[variant=pill]/tabs-list:data-[state=inactive]:hover:bg-[var(--bg-secondary)]/55 group-data-[variant=pill]/tabs-list:data-[state=inactive]:hover:text-[var(--text-secondary)] group-data-[variant=pill]/tabs-list:data-[state=inactive]:active:scale-[0.99] group-data-[variant=pill]/tabs-list:data-[state=inactive]:active:bg-[var(--bg-secondary)]/72 group-data-[variant=pill]/tabs-list:data-[state=inactive]:active:text-[var(--text-secondary)]",
        "group-data-[variant=pill]/tabs-list:data-[state=active]:border-[var(--border-strong)] group-data-[variant=pill]/tabs-list:data-[state=active]:bg-[var(--bg-secondary)] group-data-[variant=pill]/tabs-list:data-[state=active]:text-[var(--text-primary)] group-data-[variant=pill]/tabs-list:data-[state=active]:hover:border-[var(--border-strong)] group-data-[variant=pill]/tabs-list:data-[state=active]:hover:bg-[var(--bg-tertiary)] group-data-[variant=pill]/tabs-list:data-[state=active]:hover:text-[var(--text-primary)] group-data-[variant=pill]/tabs-list:data-[state=active]:active:scale-[0.99] group-data-[variant=pill]/tabs-list:data-[state=active]:active:bg-[var(--bg-secondary)]",
